...
export const DisplayData = (data) => {
  ...
  // Create a export const to generate the HTML for each data item
...
export const AddJuzAndNamaToAPI = (juzData) => {
  ...
  if (isNaN(juzInput) || juzInput < 1 || juzInput > 30) {
    ...
    return; // Stop the export const if the input is invalid
  }
...
export const CancelAllDoneStatus =() => {
